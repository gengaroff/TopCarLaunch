 ...
 */
 ...
 async function setActivity() {
    if (!RPC) return;
    RPC.setActivity({
        details: `Evento TopCar`,
        state: `A los pits!`,
        startTimestamp: Date.now(),
        largeImageKey: 'logo-destiny',
        largeImageText: `Minecraft TopCar`,
        instance: false,
        buttons: [
            {
                label: `Discord Geko Studios`,
                url: `https://discord.gg/gjJs3Unjhw`,
            },
            {
                label: `TikTok GengarOff`,
                url: `https://www.tiktok.com/@gengaroff`,
            }
        ]
    });
 };
